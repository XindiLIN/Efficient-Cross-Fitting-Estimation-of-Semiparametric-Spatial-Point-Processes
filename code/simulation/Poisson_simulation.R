#### generate Table of the simulation result of Poisson processes in the manuscript
...
write.csv(Table_2, "output/simulation/poisson_simulation_results.csv", row.names=FALSE)
