#### generate Table of the simulation result of log-Gaussian Cox processes in the manuscript
...
write.csv(Table_3, "output/simulation/lgcp_simulation_results.csv", row.names=FALSE)
