...
write.csv(simulated_field_1_large, file = "data/simulated_Gaussian_field/simulated_field_1_large.csv", row.names = FALSE)
write.csv(simulated_field_2_large, file = "data/simulated_Gaussian_field/simulated_field_2_large.csv", row.names = FALSE)