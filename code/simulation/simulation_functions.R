...
generate_simulate_covariate = function(field_1 = NULL,field_2 = NULL,is.small=TRUE,is.independent=TRUE){
  if(is.null(field_1)& is.null(field_2)){
    simulated_field_1_large = read.csv('data/simulated_Gaussian_field/simulated_field_1_large.csv')
    ...
    simulated_field_2_large = read.csv('data/simulated_Gaussian_field/simulated_field_2_large.csv')
