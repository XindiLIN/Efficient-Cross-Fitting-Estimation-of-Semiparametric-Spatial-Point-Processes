#### generate Table of the simulation result of model comparison/misspecification in the manuscript.
...
write.csv(Table_4, "output/simulation/model_misspecification_results.csv", row.names=FALSE)
